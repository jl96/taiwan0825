...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="herosection mt-xl-4">
                <img src="./images/90263182_3878137128893635_2715412224431620096_n .jpg" alt="">
                <div class="herosection_title">
                    <h2>
                        三個成就一次達成! |<br>
                        探索玉山主峰＆絕美日月潭＆風情萬種的台灣319鄉鎮 | 輕鬆自由配
                    </h2>
        ...
        <div class="row">
            ...
            <h3 class="mt-xl-3 h3_style" style="color: #FF9F1C;">
                一次集滿三樣台灣人必做的三件事!寶島大師就是你!</h3>
        </div>

        <div class="row mt-3 ">
            <div class="sm_content" style="color: #707070; text-align: left;">
                <p class="sm-text">* 登上台灣第一高峰玉山之巔</p>
                <p class="sm-text">* 環島征服台灣</p>
                <p class="sm-text">* 泳渡「水沙連」日月潭
                </p>
            ...
            <div class="col-10">
                <div class="introduce">
                    <div class="point123 d-flex flex-wrap">
                        <img src="./images/yushan_01.jpg" alt="" class="col-xl-3 pl-xl-0 col-12 ">
                        <div class="point_introduce col-xl-9 col-12">
                            <p class="sm-text mt-10">
                                -----&nbsp;&nbsp;&nbsp;Point &nbsp;1
                            </p>
                            <h3 style="color: #FF9F1C;">登上台灣第一高峰玉山之巔</h3>
                            <h5 style="color: #707070;">
                                國土面積相當狹小的台灣，3000公尺以上的高山卻有多達268座，這要歸功於地層分布的擠壓，而國土面積大台灣10倍有餘的日本，3000公尺以上的高山連20座都不到，加上近年來戶外活動的盛行，讓登山成了不少人戶外生活的首選。
                                對於想挑戰自我的登山客來說，攀登百岳是一個門檻，而百岳之中，玉山是最容易完成的一座，儘管海拔達到3952公尺是台灣第一高峰，但因為路線較為平坦寬闊、方向指示清晰，在百岳之中難易度可以說是最低的，體力好一點的甚至可以單攻。
                            </h5>
                        </div>
                    </div>
                ...
                <div class="introduce mt-xl-2">
                    <div class="point123 d-flex flex-wrap">
                        <img src="./images/travel_island.jpg" alt="" class="col-xl-3 col-12 pl-xl-0 mt-2">
                        <div class="point_introduce col-xl-9 col-12">
                            <p class="sm-text mt-10">
                                -----&nbsp;&nbsp;&nbsp;Point &nbsp;2
                            </p>
                            <h3 style="color: #FF9F1C;">環島征服台灣</h3>
                            <h5 style="color: #707070;">
                                不只有群山聳立，海岸線更是令人讚嘆，因為地理位置的關係，四面環海的台灣在各地區都擁有不同的海岸地形，北部是岬灣海岸，西部是沙質海岸，南部是珊瑚礁海岸，東部則是斷層海岸，各有各的美及特色。

                                如此美麗的景觀，就需要細細的欣賞品味，因此火車會是最好的交通工具，全台1200公里的鐵道線，望著車窗外不斷變化的景觀是非常棒的經驗。
                            </h5>
                        </div>
                    </div>
                ...
                <div class="introduce mt-xl-2">
                    <div class="point123 d-flex flex-wrap">
                        <img src="./images/sunmoonlake.jpg" alt="" class="col-xl-3 col-12 pl-xl-0 mt-2">
                        <div class="point_introduce col-xl-9 col-12">
                            <p class="sm-text mt-10">
                                -----&nbsp;&nbsp;&nbsp;Point &nbsp;3
                            </p>
                            <h3 style="color: #FF9F1C;">泳渡「水沙連」日月潭</h3>
                            <h5 style="color: #707070;">
                                日月潭是台灣非常著名的景點及地標之一，也是台灣最大的淡水湖。
                                從1983年開始，日月潭每一年都會舉辦一個盛大的活動，就是「泳渡日月潭」，全程長度大約3000公尺，每年都會吸引多達數萬人參與這場盛會，也因此就成了「萬人泳渡日月潭」的年度嘉年華，帶動了周邊的觀光商機。只要你年滿10歲，對於游泳有基本的概念就可以報名參加，但必須要五個人才能報名，同時參與的每個人都必須穿上救生衣以確保意外發生，也因為時間相當足夠，所以可以讓你在湖中慢慢欣賞四周美景!
                            </h5>
                        </div>
                    </div>
        ...
        <div class="row h3000 pt-xl-5">
            ...
            <div class="col-10">
                <div class="tabs">
                    ...
                    <label for="two"><img src="./SVG/train-img_1.svg" alt="">環島行程 </label>

                    <input id="three" name="tabs" type="radio" style="display: none;">
                    <label for="three"><img src="./SVG/swimming-img_1.svg" alt="">日月潭行程 </label>
                    ...
                    <div class="panels">
                        ...
                        <div class="panel">
                            <div class="shopping_card">
                                <?php $sql = "SELECT * FROM `product` WHERE `id`= 65";
                                ...
                                ?>
                                    ...
                                    <div class="shopping_card_main d-flex flex-wrap">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="text" class="qty form-control" placeholder="" id="qty" value="1">
                                        ...
                                        <div class="main_right col-xl-5 col-12">
                                            ...
                                            <button class="cart-btn d-none  d-xl-block mt-xl-3" style="margin: 0 auto;" id="btn_set_cart_first" data-prod-id="<?= $obj['id'] ?>" data-prod-name="<?= $obj['prod_name'] ?>" data-prod-main-img="<?= $obj['prod_main_img'] ?>" data-prod-price="<?= $obj['prod_price'] ?>">
                                                <a href="" style="color:white; ">放入購物車 </a></button>

                                            <button class=" buy-btn d-none d-xl-block  mt-xl-3" style="background-color: #FF9F1C;z-index: 300;margin: 0 auto;">
                                                <a href="" style="color:white;">立刻下訂 </a></button>
                                            <div class="price">
                                            ...
                                            <button class="cart-btn d-xl-none  d-block mt-0" style="margin: 0 auto;" id="btn_set_cart1" data-prod-id="<?= $obj['id'] ?>" data-prod-id="<?= $obj['id'] ?>" data-prod-name="<?= $obj['prod_name'] ?>" data-prod-main-img="<?= $obj['prod_main_img'] ?>" data-prod-price="<?= $obj['prod_price'] ?>">
                                                <a href="" style="color:white;">放入購物車</a> </button>

                                            <button class=" buy-btn d-xl-none d-block  mt-xl-3" style="background-color: #FF9F1C;z-index: 300;margin: 0 auto;">
                                                <a href="" style="color:white;">立刻下訂</a> </button>
                                        </div>
                            ...
                            <div class="schedule_detail mt-xl-5 mt-3" style="background-color: white; ">
                            ...
                            <div class="schedule_detail" style="background-color: white;">
                                <div class=" timeline d-flex flex-wrap">
                                    <div class="datetime col-xl-1 d-none d-xl-block">
                        ...
                        <div class="panel">
                            <div class="shopping_card">
                                <div class="shopping_card_top d-flex pr-xl-2">
                                    <div class="introduce_img col-3">
                                        <img src="./images/travel_island.jpg" alt="">
                                    </div>
                                    <div class="introduce_content">
                                        <h3 class="mt-xl-5" style="font-weight: 400;">雙北尋訪七日｜藍色公路 | 漁人碼頭 | 永安漁港 | 賞蟹大道 | 淡水河遊船 | 大稻埕碼頭</h3>
                                        <img src="./SVG/stars.svg" alt="" style="height:20px;width: 100px;">
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="165" height="37" viewBox="0 0 165 37">
                                        <g id="组_1117" data-name="组 1117" transform="translate(-987 -2325)">
                                ...
                                <div class="shopping_card_main d-flex flex-wrap">
                                            ...
                                            <table id="tab">
                                                <tr>
                                                    <div class="row">
                                                        ...
                                                        ?>
                                                            <div style="display: flex;" class="justify-content-between">
                                                                <span class="myPrice02 price pt-xl-2"><?= $obj['prod_price'] ?></span><span class="per" style="width: 40px;">/人</span>

                                                            <?php
                                                        }
                                                            ?>
                                                            <div class="input-group mb-3">
                                                                <button class="btn btn-outline-secondary" type="button" id="btn_minus02" style="position: relative;">
                                                                    <i class="fas fa-minus" style="position: absolute; top: 6px; left: 7px;"></i>
                                                                </button>
                                                                <input type="text" class="qty form-control" placeholder="" id="qty02" value="1">
                                                                <button class="btn btn-outline-secondary" type="button" id="btn_plus02" style="position: relative;">
                                                                    <i class="fas fa-plus" style="position: absolute;top: 6px; right: 7px;"></i>
                                                                </button>
                                                            </div>
                                    ...
                                    <div class="main_right col-xl-5 col-12">
                                        ...
                                        <div class="price">
                                            <p class="text-xl-center  total_price_title">總金額</p>
                                            <p style="color: #707070;text-align: right;" class="NTD">NTD</p>
                                            <span class="total_dollars total_dollars02" style="color: #FF9F1C;font-weight: bold;">
                                                <?php
                                ...
                                <div class="timeline d-flex flex-wrap">
                                    ...
                                    <div class="timeline_content col-xl-11 col-12">
                                        <div class="timline_title d-flex">
                                            ...
                                            <h3 class="h3_timeline"><span class="date_rwd">14:00
                                                </span>集合囉！
                                            </h3>
                                        </div>
                                        <div class="timeline_line_content " style="border-left:1px solid black">
                            ...
                            <div class="schedule_detail" style="background-color: white;">
                                <div class=" timeline d-flex flex-wrap">
                                    <div class="datetime col-xl-1 d-none d-xl-block">
                                        <p style="font-weight: 700px;color: #707070;">14:20</p>
                                    </div>
                                    <div class="timeline_content col-xl-11 col-12">
                                        <div class="timline_title d-flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="50.77" height="50.08" viewBox="0 0 50.77 50.08">
                                            ...
                                            <h3 class="h3_timeline"><span class="date_rwd">14:20
                                                </span>大稻埕巡禮
                                            </h3>
                                        </div>
                                        <div class="timeline_line_content " style="border-left:1px solid black">
                        ...
                        <div class="panel">
                            <div class="shopping_card">
                                <div class="shopping_card_top d-flex pr-xl-2">
                                    <div class="introduce_img col-3">
                                        <img src="./images/sunmoonlake.jpg" alt="">
                                    </div>
                                    <div class="introduce_content">
                                        <h3 class="mt-xl-5" style="font-weight: 400;">日月潭環潭挑戰&美食趣｜伊達邵｜涵碧樓｜運動+放鬆的充實之旅!
                                            <img src="./SVG/stars.svg" alt="" style="height:20px;width: 100px;">
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="165" height="37" viewBox="0 0 165 37">
                                        <g id="组_1117" data-name="组 1117" transform="translate(-987 -2325)">
                                ...
                                <div class="shopping_card_main d-flex flex-wrap">
                                            ...
                                            <table id="tab">
                                                <tr>
                                                    <div class="row">
                                                        ...
                                                        ?>
                                                            <div style="display: flex;" class="justify-content-between">
                                                                <span class="myPrice03 price pt-xl-2"><?= $obj['prod_price'] ?></span><span class="per" style="width: 40px;">/人</span>

                                                            <?php
                                                        }
                                                            ?>
                                                            <div class="input-group mb-3">
                                                                <button class="btn btn-outline-secondary" type="button" id="btn_minus03" style="position: relative;">
                                                                    <i class="fas fa-minus" style="position: absolute; top: 6px; left: 7px;"></i>
                                                                </button>
                                                                <input type="text" class="qty form-control" placeholder="" id="qty03" value="1">
                                                                <button class="btn btn-outline-secondary" type="button" id="btn_plus03" style="position: relative;">
                                                                    <i class="fas fa-plus" style="position: absolute;top: 6px; right: 7px;"></i>
                                                                </button>
                                                            </div>
                                    ...
                                    <div class="main_right col-xl-5 col-12">
                                        ...
                                        <div class="price">
                                            <p class="text-xl-center  total_price_title">總金額</p>
                                            <p style="color: #707070;text-align: right;" class="NTD">NTD</p>
                                            <span class="total_dollars total_dollars03" style="color: #FF9F1C;font-weight: bold;">
                                                <?php
        ...
        <div class="row  d-xl-block d-xl-flex d-none  pt-3  pt-xl-5 ">
                    ...
                    <div class="carousel-item active">
                        <div class="card-group ">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">ADISI 魚雷浮標AS17118 【單入】日月潭泳渡必備</h5>
                                    ...
                                    <span class="card-text" style="position: absolute; top: 380px; left: 210px;">TWD
                                        <span style="color: #FF9F1C; font-weight: bold; font-size: 20px;">725</span></span>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-top" style="position:relative;">
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="card-text" style="position: relative;"><img src="./SVG/stars.svg" alt="" style="height: 30px; width: 182px;"></span>
                                    <span class="card-text" style="position: absolute; top: 380px; left: 210px;">TWD
                                        <span style="color: #FF9F1C; font-weight: bold; font-size: 20px;">13,800</span></span>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-top" style="position:relative;">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Gore-Tex大背包縱走登山鞋【亮藍】</h5>
                                    <span class="card-text" style="position: relative;"><img src="./SVG/stars.svg" alt="" style="height: 30px; width: 182px;"></span>
                                    <span class="card-text" style="position: absolute; top: 380px; left: 210px;">TWD
                    ...
                    <div class="carousel-item">
                        <div class="card-group">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">女童防曬衝浪水母衣 OLAIAN</h5>
                                    <span class="card-text" style="position: relative;"><img src="./SVG/stars.svg" alt="" style="height: 30px; width: 182px;"></span>
                                    <span class="card-text" style="position: absolute; top: 380px; left: 210px;">TWD
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Lewis N. Clark 旅行防水收納盒(中) </h5>
                                    <span class="card-text" style="position: relative;"><img src="./SVG/stars.svg" alt="" style="height: 30px; width: 182px;"></span>
                                    <span class="card-text" style="position: absolute; top: 380px; left: 210px;">TWD
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">連身套頭式雨衣【藍】</h5>
                                    <span class="card-text" style="position: relative;"><img src="./SVG/stars.svg" alt="" style="height: 30px; width: 182px;"></span>
                                    <span class="card-text" style="position: absolute; top: 380px; left: 210px;">TWD
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Granite Gear 5000136 Perimeter登山健行背包【藍】</h5>
                                    <span class="card-text" style="position: relative;"><img src="./SVG/stars.svg" alt="" style="height: 30px; width: 182px;"></span>
                                    <span class="card-text" style="position: absolute; top: 380px; left: 210px;">TWD
                        ...
                        <div class="card-group col-12 " style="flex-direction:unset">
                            <div class="card col-6 " style="height: 200px;">
                                ...
                                <div class="card-body p-0">
                                    <h5 class="card-title">ADISI 魚雷浮標AS17118 【單入】</h5>
            ...
            <div class="col-10">
                ...
                <div class="comment d-flex">
                    ...
                    <div class="col-xl-10  col-12">
                        ...
                        <div class="img-wrap2 d-flex flex-wrap">
                            ...
                            <img src="./images/com-longdong-01.jpg" alt="" class="col-xl-3 col-6  pl-0 pr-0">
                            <img src="./images/com-longdong-03.jpg" alt="" class="col-xl-3 d-xl-flex d-none   pl-0 pr-0">
                ...
                <div class="comment d-flex">
                    ...
                    <div class="col-xl-10  col-12">
                        ...
                        <div class="img-wrap2 d-flex flex-wrap">
                            ...
                            <img src="./images/com_yu06.jpg" alt="" class="col-xl-3 col-6  pl-0 pr-0">
                ...
                <div class="comment d-flex">
                    ...
                    <div class="col-xl-10  col-12">
                        ...
                        <div class="img-wrap2 d-flex flex-wrap">
                            <img src="./images/com_yu07.jpg" alt="" class="col-xl-3 col-6 pl-0 pr-0">
                            <img src="./images/com_yu08.jpg" alt="" class="col-xl-3 col-6  pl-0 pr-0">
                            <img src="./images/com_yu09.jpg" alt="" class="col-xl-3 d-xl-flex d-none   pl-0 pr-0">
                ...
                <div class="comment d-flex">
                    ...
                    <div class="col-xl-10  col-12">
                        <p>
                            這一次的教練團有3人, 我自己加朋友是5個人, 但實際下水只有4位. 其他湊團的團員初估也是七八人(沒細算) . 因當天有團友遲到, 出發時間己至少延誤了20分鍾. 一路划行還算平順浪況, 一直划到要進入龍洞的閘口時忽然風浪加上地形關係, 浪比較強烈些. 因為朋友當下被浪打翻入水, 教練協助下又爬上板隨即又被打下水. 感謝教練團隊協助朋友, 最後是教練拉著他的板往外圍划進龍洞. 非常感謝教練的協助.
                        </p>
                        <div class="img-wrap2 d-flex flex-wrap">
    ...
    <script>
        ...
        $('button#btn_plus').click(function(event) {
            ...
            console.log(input_qty.val() * $('.myPrice').text());

            $('.total_dollars span').eq(0).text(input_qty.val() * $('.myPrice').text())
        });
        ...
        //增加商品數量 環島頁面
        $('button#btn_plus02').click(function(event) {
            let input_qty = $('input#qty02');
            input_qty.val(parseInt(input_qty.val()) + 1);


            console.log(input_qty.val());
            console.log(input_qty.val() * $('.myPrice02').text());

            $('.total_dollars02 span').text(input_qty.val() * $('.myPrice02').text())
        });

        //減少商品數量 環島頁面
        $('button#btn_minus02').click(function(event) {
            let input_qty = $('input#qty02');
            if (parseInt(input_qty.val()) - 1 < 1) return false;
            input_qty.val(parseInt(input_qty.val()) - 1);
        ...
        //增加商品數量 日月潭頁面
        $('button#btn_plus03').click(function(event) {
            let input_qty = $('input#qty03');
            input_qty.val(parseInt(input_qty.val()) + 1);


            console.log(input_qty.val());
            console.log(input_qty.val() * $('.myPrice03').text());

            $('.total_dollars03 span').text(input_qty.val() * $('.myPrice03').text())
        });

        //減少商品數量 日月潭頁面
        $('button#btn_minus03').click(function(event) {
            let input_qty = $('input#qty03');
            if (parseInt(input_qty.val()) - 1 < 1) return false;
            input_qty.val(parseInt(input_qty.val()) - 1);
